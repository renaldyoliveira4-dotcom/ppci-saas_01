...
async def api_analyze_plant(
    ...
    """
    Audita uma planta de combate a incêndio (e o memorial, se enviado) usando IA real.

    Aceita: PDF (até 32MB), PNG, JPG, WEBP (até 20MB) — para a planta e para o memorial.
